...
int main() {
    ...
    //Part 2
    fileName1 = R"(input/car.tga)";
    fileName2 = R"(input/layer2.tga)";
    taskOutput = R"(output/part2.tga)";
    ...
    //Part 3
    fileName1 = R"(input/layer1.tga)";
    fileName2 = R"(input/pattern2.tga)";
    string fileName3 = R"(input/text.tga)";
    taskOutput = R"(output/part3.tga)";
    ...
    //Part 4
    fileName1 = R"(input/layer2.tga)";
    fileName2 = R"(input/circles.tga)";
    fileName3 = R"(input/pattern2.tga)";
    taskOutput = R"(output/part4.tga)";
    ...
    //Part 5
    fileName1 = R"(input/layer1.tga)";
    fileName2 = R"(input/pattern1.tga)";
    taskOutput = R"(output/part5.tga)";
    ...
    //Part 8
    fileName1 = R"(input/car.tga)";
    string taskOutputR = R"(output/part8_r.tga)";
    string taskOutputG = R"(output/part8_g.tga)";
    string taskOutputB = R"(output/part8_b.tga)";
    ...
    //Part 9
    string fileNameR =  R"(input/layer_red.tga)";
    string fileNameG =  R"(input/layer_green.tga)";
    string fileNameB =  R"(input/layer_blue.tga)";
    taskOutput = R"(output/part9.tga)";
    ...
    //Part 10
    fileName1 = R"(input/text2.tga)";
    taskOutput = R"(output/part10.tga)";
